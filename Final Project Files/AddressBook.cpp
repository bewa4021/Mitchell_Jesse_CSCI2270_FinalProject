...
/*
void AddressBook::saveFile(fstream file){
    if(root==NULL){
...
void AddressBook::saveFile(addressNode *n,fstream in_file){
    in_file<<n->first<<","<<n->last<<","<<n->address<<","<<n->email<<","<<n->phone<<'/n';
    if(n->leftChild!=NULL){
        saveFile(n->leftChild, in_file);
    }
    if(n->rightChild!=NULL){
        saveFile(n->rightChild, in_file);
    }
}
*/
